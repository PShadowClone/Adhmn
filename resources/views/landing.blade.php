...
<head>
    ...
    <link href="{{asset('landing-assets/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
...
<body id="page-top">
<!-- START APPLICATION @AUTHOR AMR -->
<div id="app">

</div>
<!-- END APPLICATION @AUTHOR AMR -->
...
<script src="{{asset('landing-assets/js/jqBootstrapValidation.js')}}"></script>
<script src="{{asset('landing-assets/js/contact_me.js')}}"></script>

<!-- Custom scripts for this template -->
<script src="{{asset('landing-assets/js/agency.min.js')}}"></script>
